const i18nData = {
    fr: {
        ...
        UI: {
            ...
            marketingButton: "Campagne Marketing (Coût: {cost})",
            close: "Fermer",
            ok: "OK",
            ...
            investRDDescription: "Augmente la R&D de 15% et la compétitivité de 25%.",
            rationalizeDescription: "Réduit les coûts de 5% mais baisse la compétitivité de 2%.",
            launchProductDescription: "Augmente les revenus de 50% et les coûts de 25%. Le succès dépend de la R&D.",
            strategicPlanDescription: "Augmente les revenus de 10% si la compétitivité est élevée.",
            upgradeDescription: "Augmente les revenus de 50% et les coûts de 40% pour l'entreprise.",
            marketingDescription: "Augmente les revenus de 50% pendant 5 tours.",
            netWorth: "Avoir",
            avgRD: "Moyenne R&D",
    ...
    en: {
        ...
        UI: {
            ...
            marketingButton: "Marketing Campaign (Cost: {cost})",
            close: "Close",
            ok: "OK",
            ...
            investRDDescription: "Increases R&D by 15% and competitiveness by 25%.",
            rationalizeDescription: "Reduces costs by 5% but decreases competitiveness by 2%.",
            launchProductDescription: "Increases revenue by 50% and costs by 25%. Success depends on R&D.",
            strategicPlanDescription: "Increases revenue by 10% if competitiveness is high.",
            upgradeDescription: "Increases the company's revenue by 50% and costs by 40%.",
            marketingDescription: "Increases revenue by 50% for 5 turns.",
            netWorth: "Net Worth",
            avgRD: "Average R&D",
